...
(() => {
  ...
  const I18N = {
    ru: {
      ...
      'projects.florea.tag': 'Flutter · Мобильное',
      'projects.florea.desc': 'Личный трекер цикла и дневник: календарь и прогнозы, самочувствие и PMS, записи с фото, режим партнёра, Android-виджеты, аналитика, резервные копии ZIP и защита PIN. От идеи до релизов на GitHub с авто-обновлением.',
      'projects.florea.t1': 'Дневник', 'projects.florea.t2': 'Backup', 'projects.florea.t3': 'Виджет',
      'projects.florea.download': 'Скачать APK', 'projects.florea.note': 'v1.8.1 · ~60 МБ · Android · авто-обновления',
    ...
    en: {
      ...
      'projects.florea.tag': 'Flutter · Mobile',
      'projects.florea.desc': 'A personal cycle tracker and diary: calendar and predictions, wellbeing and PMS, photo entries, partner mode, Android widgets, analytics, ZIP backups and PIN protection. From idea to GitHub releases with in-app auto-updates.',
      'projects.florea.t1': 'Diary', 'projects.florea.t2': 'Backup', 'projects.florea.t3': 'Widget',
      'projects.florea.download': 'Download APK', 'projects.florea.note': 'v1.8.1 · ~60 MB · Android · auto-updates',
